...
public class EmailConfirmation {
	...
	public void sendEmail(String name,String email,String password) {
		...
		String message = "Hello Dear, Welcome to Residena..! Successfully completio";
		String subject = "CodersArea : Confirmation";
		String to = "adityamorajkar257@gmail.com";
...
//		sendEmail(message,subject,to,from);
	...
	private static void sendAttach(String message, String subject, String to, String from) {
		...
		try {
			...
			// file path
			String path = "C:\\Users\\Sharimila\\Desktop\\iphone.jpg";
