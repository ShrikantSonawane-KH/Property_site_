							...
							<div class="col-2">
								...
								<div class="dropdown show"   >
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuLink" >
										<a class="dropdown-item" value="Mumbai" href="RenterHome.jsp?city=Mumbai&id=#map"  onclick='test(a)'>Mumbai</a> 
										<a class="dropdown-item" value="Pune" href="RenterHome.jsp?city=Pune&id=#map" onclick='test(b)'>Pune</a> 
										<a class="dropdown-item" value="Nashik" href="RenterHome.jsp?city=Nashik&id=#map" onclick='test(c)'>Nashik</a>
									</div>
								</div>
